...
/*** From source: example2_traffic_light.pml ***/
...
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "example2_traffic_light.pml", 1, 5 },
	{ "-", 6, 7 }
};
uchar reached2 [] = {
	  0,   1,   0,   1,   1,   0,   0, };
...
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "example2_traffic_light.pml", 1, 6 },
	{ "-", 7, 8 }
};
uchar reached1 [] = {
	  0,   1,   1,   0,   1,   1,   0,   0, };
...
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "example2_traffic_light.pml", 1, 4 },
	{ "-", 5, 6 }
};
uchar reached0 [] = {
	  0,   0,   0,   0,   0,   0, };
...
{	/* int i; */
	printf("global vars:\n");
	printf("	mtype  NS_GREEN:	2\n");
	printf("	mtype  EW_GREEN:	1\n");
	printf("	mtype  light:	%d\n", now.light);
}
void
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("EW_GREEN"); return;
	case 2: Printf("NS_GREEN"); return;
